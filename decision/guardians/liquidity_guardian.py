...
def check_liquidity_heatmap(symbol: str, side: str, target_price: float, context_registry, fast_track: bool) -> GuardianResult:
    """
    Phase 3: Liquidity Heatmap Guardian.
    Checks if there is significant limit order liquidity (walls) at the target price.
    """
