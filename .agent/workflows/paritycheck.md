...
.venv/bin/python tests/validation/parity_data_fetcher.py --symbol LTC/USDT:USDT --start $START --end $END_TS --out tests/validation/ltc_parity.csv
```
...
.venv/bin/python backtest.py --data tests/validation/ltc_parity.csv --symbol LTC/USDT:USDT --balance 3400.0 --bet-size 0.01
