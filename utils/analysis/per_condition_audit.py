...
CONDITIONS = {
    # Range:      2026-04-12 (ltc_24h_audit.csv)
    "RANGE       (2026-04-12)": (1744416000, 1744502400),
    # Bear Normal: 2026-04-11 (ltc_bear_normal_24h.csv) -2.8%
    "BEAR NORMAL (2026-04-11)": (1744329600, 1744416000),
    # Bear Crash:  2026-04-02 (ltc_bear_24h_v2.csv) -38%
    "BEAR CRASH  (2026-04-02)": (1743552000, 1743638400),
    # Bull:        2026-04-07 (ltc_bull_24h_v2.csv) +11%
