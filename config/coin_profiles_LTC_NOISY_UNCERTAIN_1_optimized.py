...
COIN_PROFILES = {
    ...
    "LTC_NOISY_UNCERTAIN_1": {
        "description": "LTC \u2014 FB+LE edge confirmed \u2705 (FB ratio 3.73, LE ratio 1.84). Uniform TP2.50/SL4.00.",
        "sensors": {
            "absorption_detector": {
                "z_score_min": 4.0,
            ...
            "liquidity_exhaustion": {
                ...
                "level_tolerance_pct": 0.0005,
                "min_tests": 2,
                "declining_threshold": 0.9299999999999999,
                "min_bounce_pct": 0.00175,
        ...
        "targets": {
            ...
            "liquidity_exhaustion": {"tp_pct": 0.021, "sl_pct": 0.043},
