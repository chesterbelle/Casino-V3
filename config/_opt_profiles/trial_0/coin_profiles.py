...
COIN_PROFILES = {
    ...
    "LTC_NOISY_UNCERTAIN_1": {
        ...
        "sensors": {
            "absorption_detector": {
                "z_score_min": 4.800000000000001,
                "stagnation_floor_pct": 0.0006000000000000001,
                "cooldown": 110.0,
                "volatility_z_max": 2.9000000000000004,
                "displacement_z_max": 4.9,
                "level_tolerance_pct": 0.002,
                "book_bucket_pct": 0.001,
        ...
        "pressure_thresholds": {"z_block": 1.4},
        "targets": {
